...
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-2.4 definition
- `docs/specs/WP-2.3.md` -- System A implementation details
- `docs/specs/WP-2.1.md` -- World model
- `docs/specs/WP-2.2.md` -- Action engine
...
### 1. Unit Tests -- Sensor (`tests/systems/system_a/test_sensor.py`)
...
### 2. Unit Tests -- Drive (`tests/systems/system_a/test_drive.py`)
...
### 3. Unit Tests -- Policy (`tests/systems/system_a/test_policy.py`)
...
### 4. Unit Tests -- Transition (`tests/systems/system_a/test_transition.py`)
...
### 7. Unit Tests -- Config (`tests/systems/system_a/test_config.py`)
...
### 8. Integration Tests -- Full Pipeline (`tests/systems/system_a/test_pipeline.py`)
...
### 9. Behavioral Equivalence Tests (`tests/systems/system_a/test_equivalence.py`)
...
```
tests/systems/system_a/test_sensor.py       # NEW (sensor unit tests)
...
tests/systems/system_a/test_equivalence.py   # NEW (behavioral equivalence tests)
```

May also need (if not already present):

```
tests/systems/__init__.py                    # Empty (for test discovery)
tests/systems/system_a/__init__.py           # Empty (for test discovery)
```
...
1. Sensor unit tests at `tests/systems/system_a/test_sensor.py`
...
9. Behavioral equivalence tests at `tests/systems/system_a/test_equivalence.py`
