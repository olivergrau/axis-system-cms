...
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-3.1 definition
- `docs/architecture/evolution/modular-architecture-questions-answers.md` -- Q11 decision
...
tests/framework/test_registry.py    # NEW (registry tests)
```
...
### Registry Tests (`tests/framework/test_registry.py`)
...
- Tests follow established patterns from `tests/`
...
5. Updated `tests/test_scaffold.py`
6. Registry tests at `tests/framework/test_registry.py`
