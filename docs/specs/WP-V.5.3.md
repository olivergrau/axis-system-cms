...
- `docs/architecture/evolution/visualization-architecture.md` -- Sections 3, 12, 14
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.5.3
...
**File**: `tests/visualization/e2e_helpers.py` (new)
...
**File**: `tests/visualization/test_e2e_system_a_grid2d.py` (new)
...
**File**: `tests/visualization/test_e2e_system_a_toroidal.py` (new)
...
**File**: `tests/visualization/test_e2e_system_b_signal.py` (new)
...
**File**: `tests/visualization/test_e2e_system_b_grid2d.py` (new)
...
**File**: `tests/visualization/test_e2e_system_b_toroidal.py` (new)
...
**File**: `tests/visualization/test_e2e_system_a_signal.py` (new)
...
**File**: `tests/visualization/test_system_a_regression.py` (new)
...
**File**: `tests/visualization/test_cli_smoke.py` (new)
...
1. `tests/visualization/e2e_helpers.py` (shared helper module)
2. `tests/visualization/test_e2e_system_a_grid2d.py`
3. `tests/visualization/test_e2e_system_a_toroidal.py`
4. `tests/visualization/test_e2e_system_a_signal.py`
5. `tests/visualization/test_e2e_system_b_signal.py`
6. `tests/visualization/test_e2e_system_b_grid2d.py`
7. `tests/visualization/test_e2e_system_b_toroidal.py`
8. `tests/visualization/test_system_a_regression.py`
9. `tests/visualization/test_cli_smoke.py`
