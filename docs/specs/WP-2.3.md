...
- `docs/architecture/evolution/architectural-vision-v0.2.0.md` -- Sections 4 (System SDK), 12 (Step Lifecycle)
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-2.3 definition
- `docs/specs/WP-1.1.md` -- SystemInterface, DecideResult, TransitionResult, PolicyResult
- `docs/specs/WP-2.1.md` -- World extraction
- `docs/specs/WP-2.2.md` -- ActionRegistry, apply_regeneration
...
tests/test_scaffold.py                  # MODIFIED (axis.systems.system_a no longer empty)
```
...
### System A verification tests (`tests/systems/system_a/test_system_a.py`)
...
- The existing `SystemAConfigBuilder` in `tests/builders/system_config_builder.py` produces a dict matching the `SystemAConfig` structure -- verify this
...
11. Verification tests at `tests/systems/system_a/test_system_a.py`
12. Updated `tests/test_scaffold.py`
