...
- `docs/architecture/evolution/visualization-architecture.md` -- Sections 4, 5, 11 (Adapter protocols and concrete adapters)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.5.1
...
**File**: `tests/visualization/adapter_fixtures.py` (new)
...
**File**: `tests/visualization/test_world_adapter_suite.py` (new)
...
**File**: `tests/visualization/test_system_adapter_suite.py` (new)
...
**File**: `tests/visualization/test_adapter_registry_suite.py` (new)
...
**File**: `tests/visualization/test_adapter_combinations.py` (new)
...
1. `tests/visualization/adapter_fixtures.py` (shared fixture module)
2. `tests/visualization/test_world_adapter_suite.py`
3. `tests/visualization/test_system_adapter_suite.py`
4. `tests/visualization/test_adapter_registry_suite.py`
5. `tests/visualization/test_adapter_combinations.py`
