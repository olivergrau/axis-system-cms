...
- `docs/architecture/evolution/visualization-architecture.md` -- Section 10 (CanvasWidget Design)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.4.1
...
**File**: `tests/visualization/test_canvas_widget.py` (new)
...
3. `tests/visualization/test_canvas_widget.py`
