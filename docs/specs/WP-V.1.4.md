...
- `docs/architecture/evolution/visualization-architecture.md` -- Section 12 (Adapter Resolution and Registration)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.1.4
...
**File**: `tests/visualization/test_registry.py` (new)
...
2. `tests/visualization/test_registry.py` with all tests
