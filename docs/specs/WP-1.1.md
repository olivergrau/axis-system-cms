...
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-1.1 definition
- `docs/architecture/evolution/modular-architecture-questions-answers.md` -- Q1, Q2, Q4, Q14, Q15, Q16
...
- Any modifications to files outside `src/axis/sdk/` and `tests/`
...
tests/sdk/test_sdk_types.py             # NEW (verification tests)
```
...
tests/test_scaffold.py                  # UNCHANGED (may need update for non-empty sdk)
```
...
### SDK type verification tests (`tests/sdk/test_sdk_types.py`)
...
4. Verification tests at `tests/sdk/test_sdk_types.py`
