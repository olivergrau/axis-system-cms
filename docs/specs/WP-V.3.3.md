...
- `docs/architecture/evolution/visualization-architecture.md` -- Sections 13.3 (ReplayCoordinate), 14.1 (Migration map)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.3.3
...
**File**: `tests/visualization/test_viewer_state.py` (new)
**File**: `tests/visualization/test_playback_controller.py` (new)
...
4. `tests/visualization/test_viewer_state.py`
5. `tests/visualization/test_playback_controller.py`
