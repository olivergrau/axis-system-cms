...
- `docs/architecture/evolution/visualization-architecture.md` -- Section 9.4
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.0.3
...
### Extend runner tests (`tests/framework/test_runner.py`)
...
Add a new test file or extend existing: `tests/framework/test_runner_world_metadata.py`
...
3. Extended `tests/framework/test_runner.py` with world metadata tests
4. New or extended `tests/framework/test_runner_world_metadata.py` with signal_landscape and toroidal integration tests
...
tests/framework/test_runner.py                     # MODIFIED (new tests + helper update)
tests/framework/test_runner_world_metadata.py      # NEW (integration tests for non-grid_2d worlds)
```
