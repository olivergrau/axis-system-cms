...
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-1.2 definition
...
tests/sdk/test_world_contracts.py       # NEW (verification tests)
```
...
### World contract verification tests (`tests/sdk/test_world_contracts.py`)
...
5. Verification tests at `tests/sdk/test_world_contracts.py`
