...
- `docs/architecture/evolution/modular-architecture-roadmap.md` -- WP-2.2 definition
- `docs/specs/WP-1.2.md` -- ActionOutcome, MOVEMENT_DELTAS, BASE_ACTIONS
- `docs/specs/WP-2.1.md` -- World, Cell, CellType
...
tests/world/test_actions.py             # NEW (action engine tests)
tests/world/test_dynamics.py            # NEW (regeneration tests)
tests/test_scaffold.py                  # MODIFIED (updated axis.world exports)
```
...
### Action engine tests (`tests/world/test_actions.py`)
...
### Dynamics tests (`tests/world/test_dynamics.py`)
...
4. Action tests at `tests/world/test_actions.py`
5. Dynamics tests at `tests/world/test_dynamics.py`
6. Updated `tests/test_scaffold.py` for updated `axis.world` exports
