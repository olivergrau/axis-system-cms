...
- `docs/architecture/evolution/visualization-architecture.md` -- Sections 2.1, 3 (Data Flow Pipeline), 14.1 (Migration map)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.3.4
...
**File**: `tests/visualization/test_view_model_builder.py` (new)
...
3. `tests/visualization/test_view_model_builder.py`
