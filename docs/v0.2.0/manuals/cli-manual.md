...
This runs 5 episodes on a 10x10 grid with deterministic seed 42.
...
| `memory_capacity`  | `5`     | Number of recent cells remembered |
...
| `consume_weight`   | `1.5`      | Bonus applied to the "consume" action when resources present |
