...
- `docs/v0.2.0/architecture/evolution/modular-architecture-roadmap.md` -- WP-3.3 definition
...
tests/v02/framework/test_run.py              # NEW (run executor tests)
tests/v02/framework/test_experiment.py       # NEW (experiment executor tests)
```
...
### Run Tests (`tests/v02/framework/test_run.py`)
...
### Experiment Tests (`tests/v02/framework/test_experiment.py`)
...
5. Run tests at `tests/v02/framework/test_run.py`
6. Experiment tests at `tests/v02/framework/test_experiment.py`
