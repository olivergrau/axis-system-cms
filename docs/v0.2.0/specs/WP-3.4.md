...
- `docs/v0.2.0/architecture/evolution/modular-architecture-roadmap.md` -- WP-3.4 definition
...
tests/v02/framework/test_persistence.py          # NEW (repository unit tests)
tests/v02/framework/test_executor_persistence.py # NEW (executor + persistence integration)
```
...
### Repository Unit Tests (`tests/v02/framework/test_persistence.py`)
...
### Executor Persistence Integration Tests (`tests/v02/framework/test_executor_persistence.py`)
...
4. Updated `tests/v02/test_scaffold.py`
5. Repository tests at `tests/v02/framework/test_persistence.py`
6. Integration tests at `tests/v02/framework/test_executor_persistence.py`
