...
- `docs/v0.2.0/architecture/evolution/visualization-architecture.md` -- Section 11.1 (DefaultWorldVis), Section 11.2 (NullSystemVis)
- `docs/v0.2.0/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.1.3
...
**File**: `tests/v02/visualization/test_default_adapters.py` (new)
...
4. `tests/v02/visualization/test_default_adapters.py` with all tests
