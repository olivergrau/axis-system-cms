...
- `docs/v0.2.0/architecture/evolution/architectural-vision-v0.2.0.md` -- Section 3 (System Architecture)
- `docs/v0.2.0/architecture/evolution/modular-architecture-roadmap.md` -- WP-0.1 definition
- `docs/v0.2.0/architecture/evolution/modular-architecture-questions-answers.md` -- Q5
...
`tests/v02/__init__.py` files should be empty (standard pytest discovery).

`tests/v02/conftest.py` should be empty initially -- it will gain shared fixtures in WP-0.2.
...
**File**: `tests/v02/test_scaffold.py`
...
Zero modifications to any file under `src/axis_system_a/` or `tests/` (except adding the new `tests/v02/` subdirectory).
...
tests/v02/__init__.py                       # NEW (empty)
tests/v02/conftest.py                       # NEW (empty)
tests/v02/sdk/__init__.py                   # NEW (empty)
tests/v02/framework/__init__.py             # NEW (empty)
tests/v02/world/__init__.py                 # NEW (empty)
tests/v02/systems/__init__.py               # NEW (empty)
tests/v02/systems/system_a/__init__.py      # NEW (empty)
tests/v02/visualization/__init__.py         # NEW (empty)
tests/v02/test_scaffold.py                  # NEW (verification test)
```
...
### Scaffold verification test (`tests/v02/test_scaffold.py`)
...
3. The `tests/v02/` directory tree with empty `__init__.py` files
4. `tests/v02/test_scaffold.py` with the verification test
