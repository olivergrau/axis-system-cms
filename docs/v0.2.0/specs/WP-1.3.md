...
- `docs/v0.2.0/architecture/evolution/architectural-vision-v0.2.0.md` -- Section 7 (Replay Contract)
- `docs/v0.2.0/architecture/evolution/modular-architecture-roadmap.md` -- WP-1.3 definition
...
tests/v02/sdk/test_replay_contract.py       # NEW (verification tests)
```
...
### Replay contract verification tests (`tests/v02/sdk/test_replay_contract.py`)
...
4. Verification tests at `tests/v02/sdk/test_replay_contract.py`
