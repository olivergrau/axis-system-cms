...
- `docs/v0.2.0/architecture/evolution/modular-architecture-roadmap.md` -- WP-3.5 definition
...
tests/v02/framework/test_cli.py                  # NEW (CLI tests)
...
tests/v02/test_scaffold.py        # MODIFIED (update framework exports if needed)
```
...
### CLI Tests (`tests/v02/framework/test_cli.py`)
...
4. CLI tests at `tests/v02/framework/test_cli.py`
5. Updated `tests/v02/test_scaffold.py` if needed
