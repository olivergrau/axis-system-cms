...
- `docs/v0.2.0/architecture/evolution/visualization-architecture.md` -- Section 6 (Supporting Types)
- `docs/v0.2.0/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.1.1
...
**File**: `tests/v02/visualization/test_types.py` (new)

Create directory `tests/v02/visualization/` with `__init__.py`.
...
2. `tests/v02/visualization/__init__.py` (new)
3. `tests/v02/visualization/test_types.py` with construction, serialization, and import tests
