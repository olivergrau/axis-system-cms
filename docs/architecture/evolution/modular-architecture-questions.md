...
- [ ] Q1-Q3 form a consistent picture of the step lifecycle (who does what, in what order)
- [ ] Q4 and Q6-Q7 are consistent (action space, config structure, OFAT paths align)
- [ ] Q8-Q9 and Q10 form a consistent replay and visualization story
- [ ] Q5 and Q11 are compatible (package structure supports registration approach)
- [ ] Q12-Q16 define clear framework vs system boundaries
