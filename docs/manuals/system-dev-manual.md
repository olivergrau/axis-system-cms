...
2. run_episode()
   ...
   j. Framework assembles the BaseEpisodeTrace
```
...
> **Note:** Regeneration parameters (`resource_regen_rate`,
> `regeneration_mode`, `regen_eligible_ratio`) are properties of the
> world, not the system. They belong in the `world:` section of the
> experiment config. See Section 6.2 and the Configuration Reference
> Manual for details.
...
```yaml
# experiments/configs/system-b-sdk-demo.yaml
system_type: "system_b"
