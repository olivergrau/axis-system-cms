...
- `docs/architecture/evolution/visualization-architecture.md` -- Section 13 (SnapshotResolver Generalization)
- `docs/architecture/evolution/visualization-architecture-roadmap.md` -- WP-V.3.2
...
**File**: `tests/visualization/test_snapshot_resolver.py` (new)
...
3. `tests/visualization/test_snapshot_resolver.py`
